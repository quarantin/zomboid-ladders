...
Ladders.setLadderClimbingFlags = function(manager)
	...
	propsW:Set(IsoFlagType.collideW)
	propsW:Set(IsoFlagType.transparentW)
	propsW:Set(IsoFlagType.cutW)
	propsW:Set(IsoFlagType.climbSheetTopW)
	propsW:Set(IsoFlagType.HoppableW)
	propsW:Set(IsoFlagType.canPathW)
	propsW:Set(IsoFlagType.WallWTrans)
	propsW:Set(IsoFlagType.EntityScript)
	propsW:CreateKeySet()
	...
	propsN:Set(IsoFlagType.collideN)
	propsN:Set(IsoFlagType.transparentN)
	propsN:Set(IsoFlagType.cutN)
	propsN:Set(IsoFlagType.climbSheetTopN)
	propsN:Set(IsoFlagType.HoppableN)
	propsN:Set(IsoFlagType.canPathN)
	propsN:Set(IsoFlagType.WallNTrans)
	propsN:Set(IsoFlagType.EntityScript)
	propsN:CreateKeySet()
